    ...
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<int> AddUpdate(AppointmentViewModel model)
        {
            ...
            else
            {
                ...
                await _emailSender.SendEmailAsync(doctor.Email, "Appointment Created", $"Your appointment with {patient.Name} is created and in panding status");
                await _emailSender.SendEmailAsync(patient.Email, "Appointment Created", $"Your appointment with {doctor.Name} is created and in panding status");
